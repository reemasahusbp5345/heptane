...
import {PhotoCard} from './Modal/PhotoCard'
...
class HeadCard extends React.Component{
  ...
  render(){
        const {text, imgOpen, txtOpen}=this.state
    return (
      <CardWrapper>
        <AvatarBox>
        ...
        <PostBox>
          ...
          <Item>
            <svg viewBox="0 0 17 13" width="40" height="35" fill="#ff8a00">
        ...
        { imgOpen ?
           <CreatePost>
             <PhotoCard  handleModal={this.togglePhoto} />
           </CreatePost>
           :null}
      </CardWrapper>
    );
